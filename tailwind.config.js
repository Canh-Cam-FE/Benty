...
module.exports = {
	...
	theme: {
		...
		fontFamily: {
			...
			primary2: ["Fz Poppins", "sans-serif"],
		...
		extend: {
			...
			backgroundImage: ({ theme }) => ({
				...
				"Primary-Gradient": `linear-gradient(226deg, #76AECC 0%, #486F83 99.09%)`,
				"linear-header": `radial-gradient(1738.99% 141.42% at 100% 0%, #76AECC 0%, #6493AC 100%)`,
				"linear-orange": `linear-gradient(87deg, #DA4C00 -1.44%, #FF7E38 97.68%)`,
			}),
			backgroundPosition: {
				"pos-100-0": "100% 0%",
			},
			...
			boxShadow: {
				...
				"Dropshadow-Box": "0px 0px 24px 0px rgba(0, 0, 0, 0.06)",
				"Background-Blur": "",
			},
			lineClamp: {
				6: "6",
